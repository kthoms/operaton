...
public class OperatonExtensionsTest {
  ...
  public void operatonClauseOutput(DmnModelInstance originalModelInstance) {
  ...
  @MethodSource("parameters")
  @ParameterizedTest(name = "Namespace: {0}")
  public void operatonHistoryTimeToLive(DmnModelInstance originalModelInstance) {
    initOperatonExtensionsTest(originalModelInstance);
  ...
  @MethodSource("parameters")
  @ParameterizedTest(name = "Namespace: {0}")
  public void operatonVersionTag(DmnModelInstance originalModelInstance) {
    initOperatonExtensionsTest(originalModelInstance);
    Decision decision = modelInstance.getModelElementById("decision");
