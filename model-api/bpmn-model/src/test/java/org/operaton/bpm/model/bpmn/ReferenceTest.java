...
class ReferenceTest extends BpmnModelTest {
  ...
  @Test
  void shouldUpdateReferenceOnIdChange() {
  ...
  @Test
  void shouldRemoveReferenceIfReferencingElementIsRemoved() {
    assertThat(messageEventDefinition.getMessage()).isEqualTo(message);
  ...
  @Test
  void shouldRemoveReferenceIfReferencingAttributeIsRemoved() {
    assertThat(messageEventDefinition.getMessage()).isEqualTo(message);
  ...
  @Test
  void shouldUpdateReferenceIfReferencingElementIsReplaced() {
    assertThat(messageEventDefinition.getMessage()).isEqualTo(message);
  ...
  @Test
  void shouldAddMessageEventDefinitionRef() {
  ...
  @Test
  void shouldUpdateMessageEventDefinitionRefOnIdChange() {
    Collection<EventDefinition> eventDefinitionRefs = startEvent.getEventDefinitionRefs();
    assertThat(eventDefinitionRefs).contains(messageEventDefinition);
  ...
  @Test
  void shouldRemoveMessageEventDefinitionRefIfMessageEventDefinitionIsRemoved() {
  ...
  @Test
  void shouldReplaceMessageEventDefinitionRefIfMessageEventDefinitionIsReplaced() {
  ...
  @Test
  void shouldRemoveMessageEventDefinitionRefIfIdIsRemovedOfMessageEventDefinition() {
    Collection<EventDefinition> eventDefinitionRefs = startEvent.getEventDefinitionRefs();
    assertThat(eventDefinitionRefs).contains(messageEventDefinition);
