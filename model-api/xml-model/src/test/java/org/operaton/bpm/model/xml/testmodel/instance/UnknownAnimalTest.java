...
class UnknownAnimalTest {
  ...
  @Test
  void addRelationshipDefinitionToUnknownAnimal() {
  ...
  @Test
  void removeChildOfUnknownAnimal() {
  ...
  @Test
  void replaceChildOfUnknownAnimal() {
